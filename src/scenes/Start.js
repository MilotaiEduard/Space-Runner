export class Start extends Phaser.Scene {
    ...
    create() {
        ...
        this.explosionSound = this.sound.add(
            'explosionSound',
            {
                volume: 0.5
            }
    ...
    scheduleEnemyShot(enemy) {
        ...
        enemy.shootEvent = this.time.delayedCall(
            cooldown,
            () => {
                if (
                    this.isGameOver ||
